...
package com.coco.flink.examples.windowing;

import com.coco.flink.examples.wordcount.WordCount;
import com.coco.flink.examples.wordcount.util.WordCountData;
...
public class WindowWordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (params.has("input")) {
            ...
            text = env.fromElements(WordCountData.WORDS1);
        }
